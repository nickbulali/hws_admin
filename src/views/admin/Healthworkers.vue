<template>
  <div class="invoice">
    ...
    <v-container class="my-5">
      <span class="title">Health Workers</span>
        ...
        <template v-slot:items="props">
          <td class="text-xs-left">{{ props.item.users.first_name }} {{ props.item.users.last_name }}</td>
          <td class="text-xs-left">{{ props.item.worker_category.name }}</td>
          <td class="text-xs-left">{{ props.item.worker_sub_category.name}}</td>
          <td class="text-xs-left">{{ props.item.residence }}</td>
    ...
    data () {
      return {
        ...
        headers: [
          ...
          { text: 'Category', align: 'left', value: 'name' },
          { text: 'Specialiation', align: 'left', value: 'name' },
          { text: 'Residence', align: 'left', value: 'residence' },
          { text: 'License No', align: 'left', value: 'licence_number' },
          { text: 'Experience', align: 'left', value: 'experience' },
