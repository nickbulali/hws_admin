<template>
  <div class="invoice">
    ...
    <v-container class="my-5">
      <span class="title"> Monthly Requests</span>
        ...
        <template v-slot:items="props">
          <td class="text-xs-left">{{ props.item.months }}</td>
  ...
  export default {
    data () {
      return {
        ...
        headers: [
          ...
          { text: 'Month', align: 'left', value: 'requester.first_name' },
          { text: 'Category', align: 'left', value: 'category' },
          { text: 'Total Requests', align: 'left', value: 'Start Time' },
        ],
        item: [],
        categories: [],
        requests:[],
    ...
    methods: {
      ...
      initialize() {
       ...
       apiCall({ url: "/api/monthlyrequest?" + this.query, method: "GET" })
          .then(resp => {
